...
- 单继承和多继承的优缺点
    ...
    - 多继承：
        ...
        - 缺点: 继承关系混乱
- 菱形继承/砖石继承问题
    - 多个子类继承同一个父类，这些子类又被同一个类继承，于是继承关系图形成一个菱形图谱            
    - 关于多继承的MRO
...
- 构造函数
    - 在对象进行实例化的时候，系统自动调用一个函数叫做构造函数，通常此函数用来对实例对象进行初始化，顾名
...
- 无论哪种修饰符都是为了对成员属性进行相应的控制
    ...
    - property：使用当前类中的使用，可以控制一个类中多个属性
...
- 操作类
    - `__init__`:构造函数
    - `__new__`:对象实例使用化方法，此函数较特殊，一般不需要
...
# 8. 类和对象的三种方法            
- 实例方法
    - 需要实例化对象才能使用的方法，使用过程中可能需要截止对象的其他对象的方法的完成
- 静态方法
    - 不需要实例化，通过类直接访问    
- 类方法
    - 不需要实例化
